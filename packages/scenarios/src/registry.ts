...
export const scenarios: Scenario[] = [
  ...
  },
  {
    id: "recipe-creator",
    name: "Recipe creator",
    tagline: "Co-edit one live object with the agent — shared state made visible.",
    intent: "structured-editing",
    status: "planned",
    needs: ["contract intent + rules (owner-authored)", "shared data-model sync (STATE_DELTA)", "recorded fixtures"],
